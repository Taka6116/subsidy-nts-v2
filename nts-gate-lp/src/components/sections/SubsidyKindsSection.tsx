  ...
  return (
    ...
    >
      <div className={sectionContainerClass}>
        ...
        >
          <p className="label-section mb-3 text-center">対象業種</p>
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mb-12 mt-4 max-w-xl text-base leading-relaxed text-[var(--text-secondary)] md:text-lg">
              ...
              <li key={c.title} className={nestedGlassCardClass}>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {c.keywords.map((k) => (
                    <span
                      key={k}
                      className="rounded-full border border-[var(--border-subtle)] bg-[var(--bg-section-alt)] px-2.5 py-1 text-[11px] text-[var(--text-secondary)]"
                    >
                      {k}
                    </span>
                  ))}
                </div>
                <p className="mt-3 text-sm leading-relaxed text-[var(--text-secondary)]">{c.body}</p>
                <p className="mt-4 border-t border-[var(--border-subtle)] pt-4 text-sm leading-relaxed text-[var(--text-secondary)]">
