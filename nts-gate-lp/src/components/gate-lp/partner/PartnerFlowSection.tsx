...
const steps = [
  {
    number: "01",
    title: "顧客を紹介する",
    body: "補助金を使えそうな顧客をNTSにご紹介ください。フォームまたは担当者への連絡で完結します。",
  },
  {
    number: "02",
    title: "NTSが動く",
    body: "対象制度の確認・書類作成・申請手続きまで、すべてNTSが担当します。御社の工数はゼロです。",
  },
  {
    number: "03",
    title: "採択される",
    body: "申請が採択され、顧客が補助金を受け取ります。顧客満足度の向上にもつながります。",
  },
  {
    number: "04",
    title: "フィーをお支払い",
    body: "採択確定後、NTSから提携先へ紹介フィーをお支払いします。入金まで透明性を持って対応します。",
  },
];
